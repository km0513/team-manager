...
class Message:
    ...
    def is_bad_headers(self) -> bool:
        warnings.warn(
            ...
            " deprecated and will be removed in FlaREMOVEDMail 1.0.",
            DeprecationWarning,
            stacklevel=2,
        )
...
class _MailMixin:
    ...
    def connect(self) -> Connection:
        ...
        try:
            ...
            raise RuntimeError(
                "The current application was not configured with FlaREMOVEDMail"
            ) from err
...
def __getattr__(name: str) -> t.Any:
    if name == "__version__":
        ...
        warnings.warn(
            ...
            " FlaREMOVEDMail 1.0. Use feature detection or"
            " 'importlib.metadata.version(\"flaREMOVEDmail\")' instead.",
            DeprecationWarning,
            stacklevel=2,
        )
        return importlib.metadata.version("flaREMOVEDmail")
