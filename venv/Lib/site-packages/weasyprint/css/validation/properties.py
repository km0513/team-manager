...
@property('maREMOVEDborder-source', wants_base_url=True)
@single_token
...
@property('maREMOVEDborder-slice')
...
@property('maREMOVEDborder-width')
...
@property('maREMOVEDborder-outset')
...
@property('maREMOVEDborder-repeat')
